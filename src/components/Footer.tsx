        ...
        <div className="form-section flex flex-col sm:flex-row justify-between gap-10 w-full">
          <form className="w-3/5 flex flex-col gap-10">
            <div className="relative">
              <Label className="uppercase text-gray-300 text-[8px]">
                your name
              </Label>
              <Input
                placeholder="Michael"
                type="text"
                className="border-x-0 border-t-0 border-b-2 focus-visible:ring-0 text-white rounded-none border-b-white w-full px-0"
              />
            </div>
            <Input
              placeholder="your phone number"
              type="number"
              className="border-x-0 focus:outline-white focus-visible:ring-0 focus:border-b-white border-t-0 border-b-2 text-white rounded-none border-b-gray-500 w-full px-0"
            />
